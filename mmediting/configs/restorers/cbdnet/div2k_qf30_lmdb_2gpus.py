...
train_pipeline = [
    dict(
        ...
        io_backend='lmdb',
        db_path='data/div2k/train_lq_sub_qf30.lmdb',
        key='lq',
        flag='unchanged'),
    dict(
        type='LoadImageFromFile',
...
test_pipeline = [
    dict(
        type='LoadImageFromFile',
        io_backend='lmdb',
        db_path='data/div2k/valid_lq_qf30.lmdb',
        key='lq',
        flag='unchanged'),
    dict(
        type='LoadImageFromFile',
...
data = dict(
    train=dict(dataset=dict(lq_folder='data/div2k/train_lq_sub_qf30.lmdb')),
    val=dict(lq_folder='data/div2k/valid_lq_qf30.lmdb'),
    test=dict(lq_folder='data/div2k/valid_lq_qf30.lmdb'))
