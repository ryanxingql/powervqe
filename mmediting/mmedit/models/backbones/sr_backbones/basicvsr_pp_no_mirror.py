...
class BasicVSRPlusPlusNoMirror(nn.Module):
    ...
    def forward(self, lqs):
        ...
        if self.is_low_res_input:
            ...
            lqs_downsample = F.interpolate(
                ...
                mode='bicubic', align_corners=False, recompute_scale_factor=True).view(n, t, c, h // 4, w // 4)

        # check whether the input is an extended sequence
        # self.check_if_mirror_extended(lqs)  # fixme
