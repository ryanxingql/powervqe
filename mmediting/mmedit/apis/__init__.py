...
from .restoration_video_inference import (
    restoration_video_inference, restoration_video_inference_basicvsrpp)
...
__all__ = [
    ...
    'init_random_seed', 'restoration_video_inference_basicvsrpp'
]
